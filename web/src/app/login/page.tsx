  ...
  return (
    <div className="max-w-sm w-full space-y-8">
      ...
      <div className="text-center space-y-2">
        ...
        <p className="text-gray-400">Authenticate with your Google account</p>
      </div>
      ...
      <p className="text-center text-sm text-gray-500">
        ...
        <button onClick={() => router.push('/register')} className="text-primary-400 hover:text-primary-300 underline">
          Create one
        </button>
      </p>
    </div>
